        ...
        // ここに問題のリストを記述(選択式の場合は[0]に正解択をいれた配列をつくる)
        {
            ...
            groupContents: [{
                ...
                choices:["虫そのもの（虫卵検査などを含む）","免疫学的検査","遺伝子検査"],
                    answer: '遺伝子検査',
                    commentary: 'ようは遺伝子というのは一つの組織の一つの細胞を増幅させるので、非常に感度が高いのが特徴である。新型コロナウイルスもこれを利用して光源検査をしていた。遺伝子検査＞免疫学的検査（ちょっと限定した条件/抗体が賛成されないとダメ）＞虫卵検査（ベンから虫卵を検出できなければ、見落とせばそれまで）の順で感度が一般的に感度が高い。',
                  },
                  {
                    detailInfo: '9/4確認テスト',
                    questionImg: [],
